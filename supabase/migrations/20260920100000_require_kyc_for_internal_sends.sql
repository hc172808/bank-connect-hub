-- Users may sign in and receive funds before KYC approval.
-- Sending through the private internal ledger requires an approved KYC status.
-- This is enforced in the database so clients cannot bypass the UI restriction.
