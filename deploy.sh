...
# Optional service credentials — pre-fill from .env or leave blank to configure later
VITE_SUPABASE_PROJECT_ID="${VITE_SUPABASE_PROJECT_ID:-}"
VITE_WHATSAPP_SUPPORT_NUMBER="${VITE_WHATSAPP_SUPPORT_NUMBER:-}"

# Twilio SMS — leave blank to disable SMS alerts
TWILIO_ACCOUNT_SID="${TWILIO_ACCOUNT_SID:-}"
TWILIO_AUTH_TOKEN="${TWILIO_AUTH_TOKEN:-}"
TWILIO_PHONE_NUMBER="${TWILIO_PHONE_NUMBER:-}"

# SMTP Email — leave blank to disable email alerts
SMTP_HOST="${SMTP_HOST:-}"
SMTP_PORT="${SMTP_PORT:-587}"
SMTP_USER="${SMTP_USER:-}"
SMTP_PASS="${SMTP_PASS:-}"

# Web Push VAPID keys — auto-generated by build-server if not set
...
# SMS alerts (Twilio) — set to enable
TWILIO_ACCOUNT_SID=${TWILIO_ACCOUNT_SID:-}
TWILIO_AUTH_TOKEN=${TWILIO_AUTH_TOKEN:-}
TWILIO_PHONE_NUMBER=${TWILIO_PHONE_NUMBER:-}
# Email alerts (SMTP) — set to enable
SMTP_HOST=${SMTP_HOST:-}
SMTP_PORT=${SMTP_PORT:-587}
SMTP_USER=${SMTP_USER:-}
SMTP_PASS=${SMTP_PASS:-}
# Web Push (VAPID) — auto-generated by build-server if blank
VAPID_PUBLIC_KEY=${VAPID_PUBLIC_KEY:-}
VAPID_PRIVATE_KEY=${VAPID_PRIVATE_KEY:-}
ENV
chmod 600 .env
